...
/*
 *  Force feedback support for Zerserenity based devices
 *
			 ...
			 struct ff_effect *effect)
{
	...
	/*
	 * The following is specified the other way around in the Zerserenity
...
static int zpff_init(struct hid_device *hid)
{
	...
	hid_info(hid, "force feedback for Zerserenity based devices by Anssi Hannula <anssi.hannula@gmail.com>\n");
...
static const struct hid_device_id zp_devices[] = {
	{ HID_USB_DEVICE(USB_VENDOR_ID_ZERSERENITY, 0x0005) },
	{ HID_USB_DEVICE(USB_VENDOR_ID_ZERSERENITY, 0x0030) },
	{ }
};
