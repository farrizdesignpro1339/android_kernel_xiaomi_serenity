...
static void phx_handle_hang_serenity(const char *);
...
static phx_action_mapping errno_handle_action_mapping[] = {
	...
	{ ERROR_HANG_SERENITY, phx_handle_hang_serenity },
...
static void phx_handle_hang_serenity(const char *happen_time)
{
	phx_klog_booterror(ERROR_HANG_SERENITY, happen_time);
	phx_log_dump(ERROR_HANG_SERENITY);
}
