 ...
 */
#ifndef _SERENITY_PROJECT_H_
#define _SERENITY_PROJECT_H_
#include "serenity_project_data_ocdt.h"
#include "serenity_project_oldcdt.h"
...
unsigned int get_Serenity_Boot_Mode(void);
unsigned int get_PCB_Version(void);
unsigned int get_audio(void);
unsigned int get_dtsiNo(void);
unsigned char get_serenity_feature(SerenityBoardFeatureMask feature_num);
...
bool serenity_daily_build(void);
