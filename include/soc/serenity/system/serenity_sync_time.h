/***********************************************************
** Copyright (C), 2008-2019, Serenity Mobile Comm Corp., Ltd.
**
** File: serenity_sync_time.h
...
** Zhiming.Chen    2020/08/06      1.0       SERENITY_FEATURE_LOGKIT
****************************************************************/

#ifndef _SERENITY_SYNC_TIME_H
#define _SERENITY_SYNC_TIME_H
#include <linux/rtc.h>
