/***************************************************************
** Copyright (C),  2018,  SERENITY Mobile Comm Corp.,  Ltd
** File : serenity_mm_kevent_fb.h
...
******************************************************************/
#ifndef _SERENITY_MM_KEVENT_FB_
#define _SERENITY_MM_KEVENT_FB_
...
#define SERENITY_FB_ADSP_CRASH_RATELIMIT    (60 * 5 * 1000) /*ms, for mtk*/

enum SERENITY_MM_DIRVER_FB_EVENT_MODULE {
	SERENITY_MM_DIRVER_FB_EVENT_DISPLAY = 0,
	SERENITY_MM_DIRVER_FB_EVENT_AUDIO
};

/*------- multimedia bigdata feedback event id, start ------------ */
#define SERENITY_AUDIO_EVENTID_ADSP_CRASH           (10001)
#define SERENITY_AUDIO_EVENTID_HEADSET_DET          (10009)
#define SERENITY_AUDIO_EVENTID_ADSP_RECOVERY_FAIL   (10045)

#define SERENITY_DISPLAY_EVENTID_DRIVER_ERR         (12002)

#define SERENITY_DISPLAY_EVENTID_GPU_FAULT          (12005)

/*this id just for test or debug */
#define SERENITY_MM_EVENTID_TEST_OR_DEBUG           (30000)

#define SERENITY_MM_EVENTID_MAX                     (39999)
...
typedef struct mm_fb_param_t {
	enum SERENITY_MM_DIRVER_FB_EVENT_MODULE module;
...
#if IS_ENABLED(CONFIG_SERENITY_FEATURE_MM_FEEDBACK)
...
#define mm_fb_audio(id, rate_limit_ms, delay, lv, fmt, ...) \
	do { \
		mm_fb_param param = { \
			.module = SERENITY_MM_DIRVER_FB_EVENT_AUDIO, \
			.event_id = id, \
...
#define mm_fb_display_kevent(name, rate_limit_ms, fmt, ...) \
		mm_fb_kevent(SERENITY_MM_DIRVER_FB_EVENT_DISPLAY, SERENITY_DISPLAY_EVENTID_DRIVER_ERR, \
...
#define mm_fb_audio_kevent(event_id, name, rate_limit_ms, fmt, ...) \
		mm_fb_kevent(SERENITY_MM_DIRVER_FB_EVENT_AUDIO, event_id, name, rate_limit_ms, \
				fmt, ##__VA_ARGS__)
...
#else /*CONFIG_SERENITY_FEATURE_MM_FEEDBACK*/
...
#endif /*CONFIG_SERENITY_FEATURE_MM_FEEDBACK*/

#endif /* _SERENITY_MM_KEVENT_FB_ */
